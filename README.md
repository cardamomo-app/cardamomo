...
- Cmd + Ctrl + Right adds a first child when the right-hand plus is available. Cmd + Ctrl + Up/Down adds a sibling above/below. Use these while editing or focusing a card; the new card opens for writing. Cmd + Arrow keeps normal text navigation, and Shift-modified arrows keep normal text selection.
